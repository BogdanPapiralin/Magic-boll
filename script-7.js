...
document.body.innerHTML  = '	<div class ="bb"><img src="Magic_-bbb.png" id="cart" class="im" onclick="timme()"/><div><span id="aa" class="tt"></span></div><form class="leftCol7 "><span class="tex"> Введіть ваше питання</span><input class="inp tex1" type="text" id="question"><input class=" button1" type="button" name="submit" value="Відправити" onclick="timme()"> </form>'
